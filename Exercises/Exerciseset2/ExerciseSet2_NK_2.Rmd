...
```{r Fig, echo=FALSE, comment=NA, results='asis', message=FALSE, fig.align='center', fig=TRUE}
...
<br>
<br>
1. 6 factors will bring us to 52.29%
<br>
<br>
2. 5 yr T-notes US and 10yr T-notes have the highest weights of 0.93
<br>
<br>
3. 

The 10 components are related to the following:

Component 1: interest rates, or government bonds

Component 2: currencies and commodities

Component 3: European equity markets

Component 4: US equity markets

Component 5: European rates, or government bonds

Component 6: Oil

Component 7: Heavy metals

Component 8: Agricultural commodities

Component 9: Platinum metal group

Component 10: Asian equity markets
<br>
<br>
4.

For pre-crisis data,
```{r echo=TRUE, comment=NA, warning=FALSE, error=FALSE,message=FALSE,results='asis'}
...
```
<br>
```{r Fig2, echo=TRUE, comment=NA, results='asis', message=FALSE, fig.align='center', fig=TRUE}
...
```
<br>
```{r Fig3, echo=TRUE, comment=NA, results='asis', message=FALSE, fig.align='center', fig=TRUE}
...
Futures become more correlated during crisis. During pre-crisis, 15 components have eigenvalues greater than 1, which explains 69.95%. During crisis, only components have eigenvalues greater than 1, but explains 75.44%.
<br>
...
<br>
<br>
1. It takes many moving Average (MA) Signals and let them "vote" with their sign (+-1, e.g. long or short vote, for each signal). The MA frequency is indicated by `MAfreq<-seq(10,250,by=20)`. Then it makes the sum of the absolute values of the weights to 1 every day. Finally it uses the signal from 2 days ago to create trending following strategy.
<br>
<br>
2. 
By changing `MAfreq<-seq(10,250,by=20)` to `MAfreq<-seq(10,500,by=20)`, we will get a portfolio of return like Ret:5.7, Vol:7.7, Sharpe:0.74, DD: 21.9
<br>
<br>
